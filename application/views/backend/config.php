      ...
      <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="other"  style="padding-top: 10px;">
          ...
          <div class="form-group">
            ...
            <input type="text" name="contact_person" class="form-control" id="contact_person" placeholder="เบอร์ติดต่อ" value="<?=$r->contact_person;?>">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="ig" name="ig" class="form-control" id="ig" placeholder="ig" value="<?=$r->ig;?>">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="img_person">ภาพผู้ดูแล </label>
            <?php if ($r->img_person!=''):?>
            <p class="text-margin"><img class="img-thumbnail" src="<?=base_url('public/upload/'.$r->img_person);?>" style="height: 50px;"></p>
            <?php endif;?>
                      <input type="file" name="img_person" class="form-control" id="img_person" placeholder="img_person" >
          </div>
