            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Adman Admin</span>
                </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!-- Optionally, you can add icons to the links -->
			      <li class="<?=site_url();?>" style='display: none'><a href="<?=site_url();?>"><i class='fa fa-home'></i> <span>ดูเว็บไซต์</span></a></li>
            ...
            <li class="treeview <?=$this->uri->segment(2)=='room'?' active':'';?> <?=$this->uri->segment(2)=='category'?' active':'';?>">

              <a href="#"><i class='fa fa-hotel'></i> <span>จัดการผลงานส่งประกวด</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="<?=site_url('backend/category');?>">ประเภทรางวัล</a></li>
                <li><a href="">รายการประกวด</a></li>
              </ul>
            </li>


            <li class=""><a href=""><i class='fa fa-calendar'></i> <span>Agenda</span></a></li>



			<li><a href=""><i class='fa fa-link'></i> <span>สมาชิก</span></a></li>
